...
const PROGRAM = {
  days: {
    ...
    1: {
      name: 'Monday', label: 'Snatch + Lower', accent: '#5AF5C8', type: 'training',
      exercises: [
        { id: 'hang_power_snatch',  name: 'Hang Power Snatch', sets: 3, warmups: 2, repRange: [3,3], seedWeight: 135, type: 'oly', scheme: 'oly_build', pattern: 'snatch',
        ...
        { id: 'back_squat',         name: 'Back Squat',        sets: 4, repRange: [4,6], seedWeight: 250, type: 'compound', scheme: 'pyramid', pattern: 'squat',
        ...
        { id: 'leg_extension',      name: 'Leg Extension',     sets: 3, repRange: [15,20], seedWeight: 120, type: 'isolation', scheme: 'straight', pattern: 'knee_ext',
        ...
        { id: 'leg_curl',           name: 'Leg Curl',          sets: 3, repRange: [12,15], seedWeight: 120, type: 'isolation', scheme: 'straight', pattern: 'knee_flex',
    ...
    2: {
      name: 'Tuesday', label: 'Push', accent: '#F5A55A', type: 'training',
      exercises: [
        { id: 'barbell_bench_press', name: 'Barbell Bench Press', sets: 4, repRange: [4,6], seedWeight: 215, type: 'compound', scheme: 'pyramid', pattern: 'h_push',
        ...
        { id: 'incline_db_press',    name: 'Incline DB Press',    sets: 4, repRange: [10,12], seedWeight: 75, type: 'compound', scheme: 'descending', pattern: 'h_push',
    ...
    4: { name: 'Thursday',  type: 'rest', accent: '#444' },
    5: {
      name: 'Friday', label: 'Pull', accent: '#C8F55A', type: 'training',
      exercises: [
        ...
        { id: 'lat_pulldown',              name: 'Lat Pulldown',            sets: 3, repRange: [12,15], seedWeight: 150, type: 'compound', scheme: 'ramped', pattern: 'v_pull',
    ...
    6: {
      name: 'Saturday', label: 'C&J + Upper', accent: '#A55AF5', type: 'training',
      exercises: [
        { id: 'snatch_or_cj',             name: 'Snatch OR Clean & Jerk',     sets: 4, warmups: 3, repRange: [2,3], seedWeight: 185, type: 'oly', scheme: 'oly_build', pattern: 'snatch', defaultVariant: 'clean_jerk',
          variants: [
        ...
        { id: 'clean_pull_snatch_pull',    name: 'Clean Pull / Snatch Pull',    sets: 3, warmups: 2, repRange: [4,4], seedWeight: 195, type: 'oly', scheme: 'oly_build', pattern: 'oly_pull', defaultVariant: 'clean_pull',
          variants: [
  ...
  warmup: {
    1: { duration: '10–12 min', focus: 'Hip mobility + snatch prep', exercises: [
    ...
    2: { duration: '8–10 min', focus: 'Pressing prep', exercises: [
    ...
    5: { duration: '8–10 min', focus: 'Shoulder health + upper thoracic', exercises: [
      ...
      { name: 'Light Cable Face Pull', dose: '2 × 20',    note: 'Very light, groove the pattern for pulling prep' },
    ]},
  ...
  cooldown: {
    1: { duration: '8–10 min', focus: 'Hip + hamstring release', exercises: [
    ...
    2: { duration: '5–8 min', focus: 'Shoulder + wrist tissue release', exercises: [
      { name: 'Lat Overhead Stretch',   dose: '30s each', note: 'After heavy pressing — feel the lat and pec lengthen' },
      ...
      { name: 'Wrist Flexor + Extensor',dose: '30s each dir', note: 'After heavy pressing volume' },
      { name: "Child's Pose",           dose: '60s',      note: 'Full decompression — complete reset' },
    ]},
    5: { duration: '5–8 min', focus: 'Upper body tissue release', exercises: [
  ...
  coreWork: {
    1: { focus: 'Posterior Chain + McGill Big 3', exercises: [
    ...
    2: { focus: 'Anti-Extension + Anti-Rotation', exercises: [
    ...
    5: { focus: 'Flexion + Rotation + Posterior', exercises: [
      ...
      { name: 'Back Extension or Good Morning', dose: '3 × 12', note: 'Low back volume after heavy pull day' },
    ]},
  ...
  keyLifts: [
    ...
    { id: 'snatch_or_cj',       name: 'Clean & Jerk' },
    { id: 'weighted_pull_up',   name: 'Weighted Pull-Up' },
    { id: 'pendlay_row',        name: 'Pendlay Row' },
  ],

  nutrition: { calories: 2500, protein: 210, carbs: 248, fatMin: 70, fatMax: 80 },
